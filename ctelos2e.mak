...
CC    = icc.exe
#Debug:
#CCOPT = /C+ /Q+ /Fi+ /Si+ /Sp1 /Ss+ /Gm+ /Gd- /O+ /G4 /Ti+ /Tm+ /Tn+ /Tx+
#NonDebug:
...
ctelOS2E.exe: $(OBJS) ctelOS2E.mak capitel\source.os2\ctelos2a.def capitel\source.os2\capitel.rc
              $(CL) /OUT:ctelOS2E $(CLOPT) $(OBJS) $(LIBS) capitel\source.os2\ctelos2a.def
              $(RC) $(RCOPT) capitel\source.os2\capitel.rc ctelOS2E.exe
              if exist capitel\obj.os2\capitel.res del capitel\obj.os2\capitel.res
              move capitel\source.os2\capitel.res capitel\obj.os2
              $(MSGB) capitel\source.os2\ctelOS2E.lnk
